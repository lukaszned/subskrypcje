...
| Onet | Manual IMAP | Tested for MVP. Backend normalizes mobile scans to a hidden stable fast profile. |
| Interia | Manual IMAP | Tested for MVP. Backend normalizes mobile scans to a hidden stable fast profile. |
