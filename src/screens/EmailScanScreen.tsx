...
const styles = StyleSheet.create({
  ...
  heroCard: { backgroundColor: vibrantTheme.colors.cardStrong, borderRadius: 12, padding: 22, marginBottom: 16, borderWidth: 1, borderColor: vibrantTheme.colors.borderStrong, ...vibrantTheme.shadows.glow },
  heroIcon: {
    width: 48,
    height: 48,
    borderRadius: 10,
  ...
  statItem: { flex: 1, backgroundColor: 'rgba(255,255,255,0.07)', borderRadius: 10, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: vibrantTheme.colors.border },
  ...
  productModalGhost: { minHeight: 46, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  ...
  snippet: { fontSize: 13, color: vibrantTheme.colors.textMuted, lineHeight: 19, backgroundColor: 'rgba(255,255,255,0.07)', borderRadius: 10, padding: 12 },
  ...
  closeBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: vibrantTheme.colors.card, alignItems: 'center', justifyContent: 'center' },
  evidenceBox: { backgroundColor: vibrantTheme.colors.card, borderRadius: 10, padding: 14, marginBottom: 18, borderWidth: 1, borderColor: vibrantTheme.colors.border },
  ...
  trialInfo: { flexDirection: 'row', gap: 8, backgroundColor: 'rgba(251,191,36,0.12)', borderRadius: 10, padding: 12, marginBottom: 18, borderWidth: 1, borderColor: 'rgba(251,191,36,0.28)' },
