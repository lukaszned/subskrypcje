...
const styles = StyleSheet.create({
  ...
  retryButton: { marginTop: 16, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10, backgroundColor: vibrantTheme.colors.primary, ...vibrantTheme.shadows.glow },
  ...
  nextCard: { padding: 20, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.12)', marginBottom: 24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.22)' },
  ...
  emptyCard: { alignItems: 'center', padding: 24, borderRadius: 12, backgroundColor: vibrantTheme.colors.card },
  emptyTitle: { color: vibrantTheme.colors.text, fontSize: 16, fontWeight: '900', textAlign: 'center' },
  itemCard: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 12, backgroundColor: vibrantTheme.colors.card, marginBottom: 10, borderWidth: 1, borderColor: vibrantTheme.colors.border },
